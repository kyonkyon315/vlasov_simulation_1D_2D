...
void Developer_MUSCL::next_step(const double* before,double* after){
...
const double* Developer_MUSCL::roller(const double* const ptr)const{
    if(ptr < begin){
...
void Developer_MUSCL::next_step_edge(const double* before,double* after){
    double a0=courant_value*(1.+courant_value)/2.;
    double a1=1-courant_value*courant_value;
    double a2=-courant_value*(1.-courant_value)/2.;
